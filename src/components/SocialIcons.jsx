...
const SocialIcons = () => {
  ...
  return (
    <div className="socialIcons" style={styles.socialIcons}>
      <a className="icon" style={styles.icon} href="https://github.com/Atish2235">
        {/* GitHub Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.linkedin.com/in/atish-shinde-atish1304/">
        {/* LinkedIn Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.instagram.com/atish___.1304/">
        {/* Instagram Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
